+++
author = "BongweKE"
title = "Publish free blog from your phone using Github, Termux, Golang, and Hugo"
date = "2025-02-12"
description = "Lorem Ipsum Dolor Si Amet"
tags = ["opensource", "hugo", "golang", "termux"]
weight = 10
+++

1. Setup termux using fdroid 
2. Install golang
3. Install hugo using git golang command
4. Setup sync, etc
Setup theme first
